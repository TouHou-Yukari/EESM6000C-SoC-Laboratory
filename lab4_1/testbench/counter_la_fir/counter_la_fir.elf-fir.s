...
.Ltext0:
	...
	.file 0 "/home/ubuntu/Lab4_1/testbench/counter_la_fir" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L5:
	...
	add	a5,a4,a5
	sw	zero,0(a5)
	.loc 1 6 23 discriminator 3
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L4:
	.loc 1 6 17 discriminator 1
	lw	a4,-24(s0)
	li	a5,10
	ble	a4,a5,.L5
.LBE3:
...
.LASF0:
	.string	"fir.c"
.LASF1:
	.string	"/home/ubuntu/Lab4_1/testbench/counter_la_fir"
