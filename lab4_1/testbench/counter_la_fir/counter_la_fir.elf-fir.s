...
.Ltext0:
	...
	.file 0 "/home/ubuntu/lab-exmem_fir/testbench/counter_la_fir" "fir.c"
	.globl	taps
	.data
	.align	2
	.type	taps, @object
...
.L7:
	...
	add	a5,a3,a5
	sw	a4,0(a5)
	.loc 1 15 27 discriminator 3
	lw	a5,-24(s0)
	addi	a5,a5,-1
	sw	a5,-24(s0)
.L6:
	.loc 1 15 22 discriminator 1
	lw	a5,-24(s0)
	bgt	a5,zero,.L7
.LBE4:
	.loc 1 18 31
...
.LASF0:
	.string	"fir.c"
.LASF1:
	.string	"/home/ubuntu/lab-exmem_fir/testbench/counter_la_fir"
