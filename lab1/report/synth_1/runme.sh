...
HD_PWD='/home/ubuntu/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary2bcd_double_dabble.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary2bcd_double_dabble.tcl
